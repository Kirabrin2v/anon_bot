...
const reg_log_line = String.raw`\- ([0-9]{2}\.[0-9]{2}\.[0-9]{4} [0-9]{2}:[0-9]{2}:[0-9]{2}) (\+|\-)([0-9]{1,5}) TCA \(([0-9]{1,5}) TCA\) (?:(?:Передача баллов (?:от игрока|игроку) ${reg_nickname})|(?:Обмен баллов .*))`
...
const reg_limbo = new RegExp(
  'Вы попали в лимбо, перейти в лобби можно стандартными командами:\\n' +
  '([А-яё -]+: \\/\\w+\\n)+' +
  'Вы телепортированы в лимбо'
)
